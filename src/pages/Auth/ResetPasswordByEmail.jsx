...
export default function ResetPasswordByEmail() {
    ...
    const handleResend = async () => {
        ...
        try {
            ...
            setSuccessMessage('Doğrulama kodu tekrar gönderildi. Lütfen e-postanızı kontrol edin.');
            startCountdown();
        } catch (err) {
    ...
    const handleSubmit = async (e) => {
        ...
        setLoading(true);
        try {
            const result = await verificationService.completePasswordResetByEmail(email, code, password);
        ...
        <AuthLayout>
            <div className="w-full">
                ...
                <p className="text-zinc-500 mb-6 text-[15px]">
                    <strong>{email}</strong> adresinize gönderilen 6 haneli kodu ve yeni şifrenizi girin.
                </p>
                ...
                {codeIndex !== undefined && codeIndex !== null && (
                    <div className="mb-5 flex items-start gap-3 p-4 bg-zinc-50 rounded-xl border border-zinc-200 text-[13px] text-zinc-600">
                        ...
                        <span>
                            E-postanızdaki mesajda kod indeksi{' '}
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <Button
                        type="submit"
                        disabled={loading || !code || !password || !passwordConfirm}
